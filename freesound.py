################################################################################
##                                                                            ##
##      THIS SCRIPT WILL *NOT* WORK WITHOUT ENTERING YOUR CREDENTIALS         ##
##                                                                            ##
...
################################################################################
##   CHANGE THE CREDENTIALS, SECRET, AND ID BELOW TO MAKE THIS SCRIPT WORK    ##
################################################################################
...
class FreesoundClient():
    ...
    client_secret = "this is where the client secret goes"
    client_id     = "this is where the client id goes"
    token         = "" # set by another script
    header        = "" # set by another script
    
################################################################################
##              THE SCRIPT ONLY WORKS AFTER MAKING THE CHANGES                ##
################################################################################
